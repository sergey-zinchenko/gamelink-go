...
ENGINE = InnoDB;`
 ...
 PRIMARY KEY (version));`
	...
	//AddColumnDummy - add generated from data json column contains true if it's dummy registred user'
	AddColumnDummy = `ALTER TABLE gamelink.users ADD COLUMN dummy TINYINT(1) GENERATED ALWAYS AS (json_extract(data,'$.dummy')) AFTER watched_ads;`
