...
CREATE TABLE IF NOT EXISTS users (
  ...
  lb1        VARCHAR(20)                GENERATED ALWAYS AS (json_unquote(json_extract(data, '$.lb1'))) VIRTUAL,
  lb2        VARCHAR(20)                GENERATED ALWAYS AS (json_unquote(json_extract(data, '$.lb2'))) VIRTUAL,
  lb3        VARCHAR(20)            GENERATED ALWAYS AS (json_unquote(json_extract(data, '$.lb3'))),
...
user_id INT(11) NOT NULL,
score VARCHAR(20) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (id),
