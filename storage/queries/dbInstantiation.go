...
CREATE TABLE IF NOT EXISTS users (
  ...
  lb1        DOUBLE                GENERATED ALWAYS AS (json_unquote(json_extract(data, '$.lb1'))) VIRTUAL,
  lb2        DOUBLE                GENERATED ALWAYS AS (json_unquote(json_extract(data, '$.lb2'))) VIRTUAL,
  lb3        DOUBLE                GENERATED ALWAYS AS (json_unquote(json_extract(data, '$.lb3'))),
